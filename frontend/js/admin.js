  ...
  if (productFormPopup) {
    productFormPopup.addEventListener('submit', async (e) => {
      ...
      const body = {
        ...
        characteristics: {
          'визирование': form.characteristics_visibility.value,
          'диапазон': form.characteristics_temperature_range.value,
          'погрешность': form.characteristics_error ? form.characteristics_error.value : '',
          'спектральный_диапазон': form.characteristics_spectral ? form.characteristics_spectral.value : '',
          ...
          'устройство_визирования': form.characteristics_sight ? form.characteristics_sight.value : '',
          'госреестр': form.characteristics_registry ? form.characteristics_registry.value : '',
          'для_малых_объектов': form.characteristics_small_objects ? form.characteristics_small_objects.value : '',
          'особенности': getMultiSelectValues(form.characteristics_features),
          'принцип_действия': form.characteristics_principle ? form.characteristics_principle.value : '',
          'материалы': getMultiSelectValues(form.characteristics_materials),
          'температура_мин': form.characteristics_temperature_min.value,
          'температура_макс': form.characteristics_temperature_max.value
        },
        seo: {
